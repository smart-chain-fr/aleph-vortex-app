...
class ContractFactoryFA2:
    storage_table_name = "contract_factory_fa2_storage"
    operations_table_name = "contract_factory_fa2_operations"
    ...
    async def processContract(rpcEndpoint, dbConnection, contractAddress, table_name=operations_table_name):
        ...
        contractStorage = ContractFactoryFA2(**storageResponse)
        try:
