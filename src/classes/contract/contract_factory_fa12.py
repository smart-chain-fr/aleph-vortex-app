...
class ContractFactoryFA12:
    storage_table_name = "contract_factory_fa12_storage"
    operations_table_name = "contract_factory_fa12_operations"
    ...
    async def processContract(rpcEndpoint, dbConnection, contractAddress, table_name=operations_table_name):
        ...
        contractStorage = ContractFactoryFA12(**storageResponse)
        try:
